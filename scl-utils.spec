...
Patch4:     0004-macros-don-t-always-expect-brp-java-repack-jars.patch
...
%changelog
* Fri Feb 17 2017 Pavel Raiskup <praiskup@redhat.com> - 2.0.1-11.1
- fix %%scl_package macro for f26 redhat-rpm-config (rhbz#1409277)
